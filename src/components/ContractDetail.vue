<template>
    ...
    <table>
        <tr>
            ...
            <td><CardanoScan type="transaction" :value="contract.utxo.txHash"></CardanoScan></td>
        </tr>
        <tr>
            <th>Hash</th>
            <td>{{ contract.hash }}</td>
        ...
        <tr>
            <th>Owner</th>
            <td><CardanoScan type="address" :value="'60' +  contract.datum.owner"></CardanoScan></td>
        </tr>
        <tr>
            <th>PolicyId</th>
            <td><CardanoScan type="tokenPolicy" :value="contract.datum.policyId"></CardanoScan></td>
        </tr>
        <tr>
            <th>Reward</th>
            <td><CardanoScan type="token" :value="contract.datum.reward.policyId + contract.datum.reward.name" :name="toText(contract.datum.reward.name)"></CardanoScan></td>
        </tr>
        <tr>
            <th>Reward time</th>
